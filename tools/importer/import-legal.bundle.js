var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    name: "legal",
    description: "Legal and compliance pages including privacy policy, terms of use, and legal notices",
    urls: [
      "https://www.cvent.com/en/privacy-policy",
      "https://www.cvent.com/en/product-terms-of-use",
      "https://www.cvent.com/en/website-terms-use",
      "https://www.cvent.com/en/company/legal"
    ],
    blocks: [
      {
        name: "columns-media",
        instances: [".paragraph--type--header-banner-media", ".paragraph--type--compound-media-bar"]
      }
    ]
  };
